...
import stink5.oauth2.lab1.server.AuthHttpClientServlet;
import stink5.oauth2.lab1.server.HttpClientServlet;
import stink5.oauth2.lab1.server.PrivateServlet;
import stink5.oauth2.lab1.server.PublicServlet;
import stink5.oauth2.lab1.server.TokenServlet;

public class Launcher {

    private static final String PUBLIC_URL = "http://localhost:9001/api/brands";
    private static final String PRIVATE_URL = "http://localhost:9001/api/brand/Kia/models";
    private static final String AUTHORIZE_URL = "http://localhost:9001/oauth/authorize?client_id=%s&response_type=code";
    private static final String ACCESS_TOKEN_URL = "http://localhost:9001/oauth/token";
